...
const templates = [
  {
    ...
    icon: Presentation,
    color: 'bg-blue-500',
    preview: 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop'
  },
  {
    id: 2,
    name: 'Sales Pitch',
    ...
    icon: Target,
    color: 'bg-green-500',
    preview: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop'
  },
  {
    id: 3,
    name: 'Team Update',
    ...
    icon: Users,
    color: 'bg-purple-500',
    preview: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop'
  },
  {
    id: 4,
    name: 'Creative Brief',
    ...
    icon: Palette,
    color: 'bg-pink-500',
    preview: 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop'
  }
];
...
export const CreatePresentation: React.FC<CreatePresentationProps> = ({ 
  ...
  const handleGenerate = async () => {
    ...
    if (!onCreatePresentation()) {
      return; // This will trigger the payment modal
    }
  ...
  const canGenerate = userPlan === 'pro' || freeUsage.presentations < freeUsage.limit;
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Describe what you want to present, and our AI will create a beautiful presentation for you in seconds.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">AI-Powered Generation</h2>
                <p className="text-gray-600">Tell us what you want to present</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center text-sm text-gray-500">
                ...
                <span>Tip: Be specific about your topic, audience, and desired outcome for best results</span>
              </div>
            </div>

            {/* AI Suggestions */}
            <div className="mt-6">
              <h3 className="text-sm font-medium text-gray-700 mb-3">Popular prompts:</h3>
          ...
          {/* Template Selection */}
          <Card className="p-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Choose a Template Style</h3>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            <Button
              ...
              disabled={!prompt.trim() || !selectedTemplate || !canGenerate}
              size="lg"
            ...
            {!canGenerate && (
              <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                <p className="text-sm text-orange-800 font-medium">Credits Exhausted</p>
                <p className="text-xs text-orange-600 mt-1">
                  You've used all your free presentations. Upgrade to Pro for unlimited access.
                </p>
                <Button
                  onClick={onUpgrade}
                  size="sm"
            ...
            {isGenerating && (
              <div className="mt-4 space-y-3">
                <div className="text-center">
                  <p className="text-sm font-medium text-gray-700">{generationSteps[generationStep]}</p>
                </div>
                ...
                <p className="text-xs text-gray-500 text-center">
                  This may take a few moments. We're creating something amazing for you!
                </p>
              </div>
            )}
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Smart Content</p>
                  <p className="text-xs text-gray-600">AI generates relevant content</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Auto Design</p>
                  <p className="text-xs text-gray-600">Beautiful layouts automatically</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Smart Structure</p>
                  <p className="text-xs text-gray-600">Logical flow and organization</p>
                </div>
              </div>
            </div>
          </Card>
